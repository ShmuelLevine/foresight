...
class Model:
    ...
    def __init__(self, model, data, data_freq, seq_len, data_transform = None):
        fxu.ValidateType(model, arg_name='model', reqd_type=tensorflow.keras.Model, err_msg='must be an instance of tensorflow.keras.Model')
        fxu.ValidateType(data, arg_name = 'data', reqd_type=numpy.ndarray, err_msg='must be an instance of numpy.array')
        fxu.ValidateType(data_freq, arg_name = 'data_freq', reqd_type=TD, err_msg='must be an instance of pandas.Timedelta')
